(() => {
  ...
  const I18N = {
    en: {
      ...
      enable: 'Enable Extension', disable: 'Disable', enabled: 'Enabled', disabled: 'Disabled'
    },
    ar: {
      ...
      enable: 'تفعيل الإضافة', disable: 'تعطيل', enabled: 'مفعل', disabled: 'معطل'
    },
    fr: {
      ...
      enable: 'Activer l\'extension', disable: 'Désactiver', enabled: 'Activé', disabled: 'Désactivé'
    },
    es: {
      ...
      enable: 'Activar extensión', disable: 'Desactivar', enabled: 'Activado', disabled: 'Desactivado'
    },
    tr: {
      ...
      enable: 'Uzantıyı Etkinleştir', disable: 'Devre Dışı Bırak', enabled: 'Etkin', disabled: 'Devre Dışı'
    },
    id: {
      ...
      enable: 'Aktifkan Ekstensi', disable: 'Nonaktifkan', enabled: 'Aktif', disabled: 'Nonaktif'
    }
  };

  const elements = {
    languageSelect: document.getElementById('languageSelect'), themeToggle: document.getElementById('themeToggle'), powerToggle: document.getElementById('powerToggle'), languageLabel: document.getElementById('languageLabel'),
